...
<html lang="en">
    <head>
        ...
        <link rel="icon" href="{{ asset('assets/img/Lambang_BC.png') }}" />
        ...
        <link href="{{ asset('assets/css/adminlayout.css') }}" rel="stylesheet" />
        <link href="{{ asset('assets/css/hovercard.css') }}" rel="stylesheet" />
