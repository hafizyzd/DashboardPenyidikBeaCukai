<nav class="sb-topnav navbar navbar-expand fixed-top" style="background-color:#123458">
    ...
    <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
        ...
        <a class="nav-link dropdown-toggle" id="navbarDropdown" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false" style="background-color:#123458"><i class="fas fa-user fa-fw"></i></a>
